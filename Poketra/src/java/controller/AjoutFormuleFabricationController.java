 ...
 * @author ITU
 */
@WebServlet(name = "AjoutFormuleFabricationController", urlPatterns = {"/AjoutFormuleFabricationController"})
public class AjoutFormuleFabricationController extends HttpServlet {
